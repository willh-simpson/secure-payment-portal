...
export const PaymentForm: React.FC<Props> = ({ repo }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-xl mt-6">
            <form onSubmit={handleSubmit} className="w-full flex flex-col items-stretch space-y-6">
